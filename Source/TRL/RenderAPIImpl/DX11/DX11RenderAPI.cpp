...
{
    m_FeatureLevel = (D3D_FEATURE_LEVEL)desc.PlatformData.DXGIFeatureLevel;
    m_D3DDevice = (ID3D11Device*)desc.PlatformData.D3D11Device;
    m_D3DDeviceContext = (ID3D11DeviceContext*)desc.PlatformData.D3D11DeviceContext;
}
